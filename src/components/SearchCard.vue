<template>
    <div class="box-card">
      ...
      <div style="text-align: center">
        <span>
          <el-cascader popper-class="pc-sel-area-cascader" placeholder="你可以选择所在地区" size='large' style="width: 420px" :options='options' v-model='selectedOptions' @change='addressChange'></el-cascader>
        </span>
