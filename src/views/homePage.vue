...
import {Burger, Search} from "@element-plus/icons-vue";
import {ElAutocomplete, ElCol, ElDivider, ElRow} from "element-plus";
export default {
  name: "homePage",
  components:{Search, Burger, HeaderTag, SearchCard, ElDivider, ElRow, ElCol, ElAutocomplete},
  data(){
    return{
