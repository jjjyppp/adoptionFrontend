...
<!--import {ElPagination, ElCascader, ElButton, ElIcon, ElSelect, ElOption, ElCheckboxGroup, ElCheckbox} from "element-plus";-->
...
<!--export default {-->
<!--  name: "adoptionPage",-->
<!--  components:{ElPagination, ElCascader, ElButton, ElIcon, ElSelect, ElOption, ElCheckboxGroup, ElCheckbox, Search, Location, HeaderTag, AdoptionCard},-->
<!--  data(){-->
<!--    return {-->
<!--      options: regionData,-->
...
<!--&lt;!&ndash;  <input v-model="searchQuery" @input="handleInput" placeholder="输入搜索关键字">&ndash;&gt;-->
<!--  <div class="search">-->
<!--&lt;!&ndash;    <span class="icon">&ndash;&gt;-->
<!--&lt;!&ndash;      <img width="50" style="padding-top: 20px" src="../assets/icons/address.png" alt="">&ndash;&gt;-->
<!--&lt;!&ndash;    </span>&ndash;&gt;-->
<!--    <div class="icon">-->
...
<!--        <el-checkbox class="checkbox" label="已免疫"></el-checkbox>-->
<!--        <el-checkbox class="checkbox" label="已驱虫"></el-checkbox>-->
<!--        <el-checkbox class="checkbox" label="已绝育"></el-checkbox>-->
<!--      </el-checkbox-group>-->
<!--    </div>-->
<!--&lt;!&ndash;    <span>&ndash;&gt;-->
<!--&lt;!&ndash;      <input class="input" type="text" placeholder="请输入宠物种类或品种" :value="type" @input="onInput"/>&ndash;&gt;-->
<!--&lt;!&ndash;    </span>&ndash;&gt;-->
<!--&lt;!&ndash;    <span>&ndash;&gt;-->
<!--&lt;!&ndash;      <el-button style="height: 40px">&ndash;&gt;-->
<!--&lt;!&ndash;        <el-icon >&ndash;&gt;-->
<!--&lt;!&ndash;          <Search />&ndash;&gt;-->
<!--&lt;!&ndash;        </el-icon>&ndash;&gt;-->
